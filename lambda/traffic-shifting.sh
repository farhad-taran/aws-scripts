...
LATEST_VERSION=$(./get-latest-version.sh FUNCTION=$FUNCTION REGION=$REGION)
...
do
    ...
    ./split-traffic.sh FUNCTION=$FUNCTION ALIAS=LATEST VERSION=$PREVIOUS_VERSION PERCENTAGE=$PREVIOUS_VERSION_PERCENTAGE REGION=$REGION
done
